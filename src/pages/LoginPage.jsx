  ...
  return (
    ...
    >
      <img
        ...
        alt="Google"
        style={{ width: 26, marginRight: 12, display: "inline-block" }}
      />
      구글로 로그인
    </button>
  );
  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        width: "100vw",
        background: "linear-gradient(140deg,#e9f7ff 60%, #f6f7fe 100%)",
        display: "flex",
        alignItems: "center",
    ...
    >
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle at 70% 30%, #60bfff77 80%,transparent 100%)",
          filter: "blur(8px)",
          zIndex: 0,
        }}
      />
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle at 20% 80%, #ffc08266 75%,transparent 100%)",
          filter: "blur(14px)",
          zIndex: 0,
        }}
      />
      ...
      >
        <img
          ...
          style={{
            ...
            display: "block",
            filter: "drop-shadow(0 1px 10px #15a1fa44)",
          }}
        />
        <h2
          style={{
        ...
        <Login
          ...
          buttonProps={{
            style: {
              background: "linear-gradient(90deg,#7dd2fb 22%,#4ca2fd 78%)",
              color: "#fff",
              borderRadius: "10px",
              padding: "11px 0",
              marginTop: "10px",
