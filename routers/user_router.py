...
GOOGLE_CLIENT_ID = "665514448533-srrqovu7kk0j9tepjtmqa6vi5qnnv4bf.apps.googleusercontent.com"
GOOGLE_CLIENT_SECRET = "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"
...
def google_login():
    google_auth_endpoint = (
        ...
        "&scope=openid%20email%20profile"  # <--- 필수
        "&access_type=offline"
        "&prompt=consent"
    )
...
def google_callback(code: str):
    ...
    ## React로 리디렉션
    return RedirectResponse(url=f"http://localhost:3000/chat?token={jwt_token}")
